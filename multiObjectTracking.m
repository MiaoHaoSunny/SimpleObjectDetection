...
% create system objects used for reading video, detecting moving objects,%创建用于阅读视频的系统对象，检测移动的对象，
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader(filename);         %读入视频
        
        % create two video players, one to display the video,
        % and one to display the foreground mask
        obj.videoPlayer = vision.VideoPlayer('Position', [20, 400, 700, 400]);   %创建两个窗口、[left bottom width height].
